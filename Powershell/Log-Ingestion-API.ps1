...
$LogAnalyticsSubscription              = "72518812-7f95-4ccf-a0e3-27ee9128be36"
$LogAnalyticsResourceGroup             = "test-rg"
$LoganalyticsWorkspaceName             = "PWLLog"
$LoganalyticsLocation                  = "East US 2"
...
# Connect to Microsoft Graph
    $MgScope = @(
                    "Application.ReadWrite.All", "Directory.Read.All", "Directory.AccessAsUser.All",
